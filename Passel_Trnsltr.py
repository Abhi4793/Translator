...
#Chat application list
    ...
    Activelabel = Label(ChatWindow, text = "Active Chats")
...
btn2 = Button(label_frame, text ="Chat Translate", borderwidth=1, width=12, height=5, relief="ridge", command = openchatselection)
...
btn3 = Button(label_frame, text ="Video Translate", borderwidth=1, width=12, height=5, relief="ridge", command = VideoBrowse)
